    ...
    <div class="flex items-center justify-center min-h-screen bg-gray-100">
        <div class="w-full max-w-md p-8 bg-white rounded-lg shadow-md">
            ...
            <form action="{{ route('register') }}" method="post" class="space-y-4">
                @csrf
                @if($errors->any())
                    <div class="p-4 mb-4 text-sm rounded-base bg-red-200">
                        <ui>
                ...
                <button type="submit"
                    class="w-full px-4 py-2 font-bold text-white bg-gray-800 rounded-md hover:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2">
                    Register
                </button>
            </form>

            <div class="mt-4 text-center">
                <p class="text-sm text-gray-600">Already have an account? <a href="{{ route('loginPage') }}"
